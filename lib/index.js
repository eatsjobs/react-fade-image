...
var intersectionObserverSupport = exports.intersectionObserverSupport = "IntersectionObserver" in window;
var isIntersecting = exports.isIntersecting = function isIntersecting(element) {
...
var _intersectionObserver = __webpack_require__(5);
        ...
        value: function componentDidMount() {
            ...
            this.observer = new IntersectionObserver(function (entries) {
                entries.forEach(function (entry) {
                    if ((0, _intersectionObserver.isIntersecting)(entry)) {
                        _this2.loadImage();
                        _this2.observer.unobserve(_this2.refs.container);
                    }
                });
            }, options);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement('img', { ref: function ref(image) {
                        return _this3.imageElement = image;
